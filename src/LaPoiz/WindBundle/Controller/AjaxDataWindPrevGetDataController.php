...
class AjaxDataWindPrevGetDataController extends Controller
{
	/**
	 * @Template()
	 */
		...
		try {
			...
			if (isset($id)) {
				...
				return $this->container->get('templating')->renderResponse(
					'LaPoizWindBundle:Ajax:testdataWindPrev.html.twig',
					array(	'chrono' => $data[2],
							'step' => $data[0],
							'info' => $data[1],
	...
	*/
	...
	public function removePrevisionDateAction($id=null)
	{
		...
		return $this->container->get('templating')->renderResponse(
										'LaPoizWindBundle:Ajax:simpleText.html.twig',
										array('text' => $result));
	}
	...
	function errorReturn($message) {
		return $this->container->get('templating')->renderResponse(
					        		'LaPoizWindBundle:Ajax:errorText.html.twig',
									array('text' => $message ));
	}
}